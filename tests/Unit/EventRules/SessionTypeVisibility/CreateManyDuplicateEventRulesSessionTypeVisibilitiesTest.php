...
class CreateManyDuplicateEventRulesSessionTypeVisibilitiesTest extends DatabaseTestCase
{

  /****************************************************************************/

  /**
  * Test creating many duplicate EventRulesSessionTypeVisibility.
  *
  * @return void
  */
  public function testCreateManyDuplicateEventRulesSessionTypeVisibilities ()
  {
    ...
    $entries = EventRulesSessionTypeVisibility::inRandomOrder()->limit( $max )->get();
    ...
    foreach( $entries as $session_type3 )
    {
      ...
      try
      {
        ...
        $session_type4                    = new EventRulesSessionTypeVisibility();
