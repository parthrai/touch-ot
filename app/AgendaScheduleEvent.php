...
class AgendaScheduleEvent extends Model
{
  ...
  protected $dispatchesEvents = [
    'created' => AgendaScheduleEventObserver::class,
    'saved'   => AgendaScheduleEventObserver::class,
    'deleted' => AgendaScheduleEventObserver::class
