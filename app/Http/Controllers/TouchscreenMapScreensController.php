...
class TouchscreenMapScreensController extends Controller
{
  ...
  public function index ( Request $request, $event_instance_name )
  {
    ...
    $event_instance = TouchscreenMapScreensController::GetEventInstanceByName( $event_instance_name );
    $screens        = MapScreen::
    ...
    return(
      view( 'touch-screen.ts-map-screens.index' )
      ->with(
        [
  ...
  public function create_form ( Request $request, $event_instance_name )
  {
    ...
    return(
      view( 'touch-screen.ts-map-screens.create' )
      ->with(
        [
          'event_instance_name' => $event_instance->name,
  ...
  public function create ( Request $request, $event_instance_name )
  {
    ...
    $screen->caption           = $request->input( 'caption' );
    ...
    {
      return(
        redirect( route( 'ts-map-screens', [ 'event_instance_name' => $event_instance->name ] ) )
        ->with(
          [
            'flash_error'         => 'Failed to create new Map Screen',
    ...
    return(
      ...
      ->with(
        [
          'flash_success'       => 'New Map Screen Added',
          'event_instance_name' => $event_instance->name
        ]
      )
    );
  ...
  public function edit ( Request $request, $event_instance_name, $id )
  {
    ...
    if( isset( $screen ) )
    {
      ...
      return(
        view( 'touch-screen.ts-map-screens.update' )
        ->with(
          [
            'event_instance_name' => $event_instance->name,
            'screen'              => $screen,
    ...
    else
    {
      ...
      return(
        ...
        ->with(
          [
            'flash_error'         => 'Map Screen Not Found!',
            'event_instance_name' => $event_instance->name
          ]
        )
      );
    ...
    if( isset( $screen ) )
    {
      ...
      catch( Exception $ex )
      {
        return(
          ...
          ->with(
            [
              'flash_error'         => 'Failed to update Map Screen',
              'flash_exception'     => $ex->getMessage(),
              'event_instance_name' => $event_instance->name
            ]
          )
      ...
      return(
        ...
        ->with(
          [
            'flash_success'       => 'Map Screen Updated',
            'event_instance_name' => $event_instance->name
          ]
        )
      );
  ...
  public function bumpOrderDown ( Request $request, $event_instance_name, $id )
  {
    ...
    if( isset( $screen ) )
    {
      ...
      return(
        ...
        ->with(
          [
            'flash_success'       => 'Map Screen Order Adjusted',
            'event_instance_name' => $event_instance->name
          ]
        )
      );
  ...
  public function activate ( Request $request, $event_instance_name, $id )
  {
    ...
    return(
      ...
      ->with(
        [
          'flash_success'       => 'Map Screen ' . $screen->id . ' activated',
          'event_instance_name' => $event_instance->name
        ]
      )
    );
  ...
  public function deactivate ( Request $request, $event_instance_name, $id )
  {
    ...
    return(
      ...
      ->with(
        [
          'flash_success'       => 'Map Screen ' . $screen->id . ' deactivated',
          'event_instance_name' => $event_instance->name
        ]
      )
    );
  ...
  public function delete ( Request $request, $event_instance_name, $id )
  {
    ...
    if( isset( $screen ) )
    {
      ...
      return(
        ...
        ->with(
          [
            'flash_success'       => 'Map Screen Deleted',
            'event_instance_name' => $event_instance->name
          ]
        )
      );
